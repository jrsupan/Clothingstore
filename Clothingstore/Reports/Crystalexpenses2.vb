...
Public Class Crystalexpenses2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clothingstore.Crystalexpenses2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalexpenses2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalexpenses2 = New Crystalexpenses2()
        rpt.Site = Me.Site
        Return rpt
    End Function
