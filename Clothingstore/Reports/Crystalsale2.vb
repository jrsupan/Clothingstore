...
Public Class Crystalsale2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clothingstore.Crystalsale2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalsale2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalsale2 = New Crystalsale2()
        rpt.Site = Me.Site
        Return rpt
    End Function
