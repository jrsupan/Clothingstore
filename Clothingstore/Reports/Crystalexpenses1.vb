...
Public Class Crystalexpenses1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clothingstore.Crystalexpenses1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalexpenses1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalexpenses1 = New Crystalexpenses1()
        rpt.Site = Me.Site
        Return rpt
    End Function
