...
Public Class Crystalsale1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clothingstore.Crystalsale1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalsale1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalsale1 = New Crystalsale1()
        rpt.Site = Me.Site
        Return rpt
    End Function
