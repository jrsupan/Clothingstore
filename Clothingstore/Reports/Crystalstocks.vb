...
Public Class Crystalstocks
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Clothingstore.Crystalstocks.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalstocks
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crystalstocks = New Crystalstocks()
        rpt.Site = Me.Site
        Return rpt
    End Function
